...
// e-z params  
$dim = 400;         /* image displays proportionally within this square dimension ) */  
...
<head>  
    ...
    <style>  
        ...
        img {border:5px solid #303030; padding:0; verticle-align: middle; width: 100%; height: auto;}  
...
foreach($files as $file){  
    ...
    $str = sprintf('<img src="%s" title="%s" alt="">',   //width="%d" height="%d" 
        $thumbSrc,  
        // $width,  
        // $height,  
        $fileBaseName  
